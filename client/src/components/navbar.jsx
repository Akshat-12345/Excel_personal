  ...
  return (
    <>
      ...
      <style>{`
        ...
        .nav-logo { height: 50px; width: 50px; margin-right: 10px; display: block; animation: gentlePulse 3s infinite ease-in-out; transition: all 0.3s ease; color: #0088a9; }
        ...
        .custom-sidebar {
          ...
          background-color: #181818; transform: translateX(-100%); transition: transform 0.4s cubic-bezier(0.25, 0.8, 0.25, 1);
          z-index: 1001; padding: 130px 40px 0 50px; box-shadow: 5px 0 15px rgba(0, 0, 0, 0.5); font-family: 'Helvetica Neue', sans-serif;
        }
        .custom-navbar.scrolled ~ .custom-sidebar { padding-top: 80px; }
        .custom-sidebar.open { transform: translateX(0); }
        .close-btn { position: absolute; top: 40px; left: 40px; font-size: 45px; cursor: pointer; transition: all 0.3s ease; color: white; line-height: 1; }
        ...
        .sidebar-links li { padding: 20px 0; font-size: 30px; color: #aaa; cursor: pointer; position: relative; transition: all 0.3s ease; font-weight: bold; }
        .sidebar-links li::after { content: ''; position: absolute; bottom: 10px; left: 0; width: 0; height: 3px; background: #ffc000; transition: width 0.3s ease; }
