        ...
        <div className="relative z-10 flex flex-col md:flex-row w-full justify-between max-w-7xl mx-auto px-6 pt-[150px] pb-[100px]">
          ...
          <div className="w-full md:w-1/2 p-4 md:pr-16 flex flex-col justify-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md w-max mb-8 shadow-[0_0_15px_rgba(0,136,169,0.2)]">
              ...
              <span className="text-xs font-semibold tracking-wider text-gray-300 uppercase">SheetSense 2.0 Live</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight tracking-tight">
              Unlock Your <br /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0088a9] via-[#00b4d8] to-[#ffc000] drop-shadow-[0_0_30px_rgba(0,136,169,0.3)]">
                Data Potential.
              </span>
            </h1>
            <p className="text-base md:text-lg text-gray-400 mb-10 max-w-md leading-relaxed font-light">
              Securely log in to analyze complex datasets, generate 3D visualizations, and get AI-driven insights in seconds.
            </p>
            ...
            <div className="w-full relative p-[1px] rounded-3xl bg-gradient-to-br from-white/20 via-transparent to-white/5">
              <div className="w-full h-full bg-[#0a0a0a]/80 backdrop-blur-3xl p-10 md:p-12 rounded-[23px] shadow-2xl relative overflow-hidden">
                ...
                <div className="mb-10 text-center md:text-left">
                  <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight">Sign In</h2>
                  <p className="text-gray-400 text-sm mt-3">Welcome back. Enter your details below.</p>
                </div>

                <form className="space-y-6" onSubmit={handleLogin}>
                  
                  {/* Floating Label Style Input - Email */}
                  ...
                  {/* Floating Label Style Input - Password */}
                  <div className="relative group/input">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                    ...
                    <a href="#" className="absolute right-4 top-1/2 -translate-y-1/2 text-xs text-gray-400 hover:text-[#ffc000] transition-colors z-20">Forgot?</a>
                  </div>
                ...
                <div className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#0088a9] to-transparent opacity-50"></div>
              </div>
            </div>
          </div>
        </div>
